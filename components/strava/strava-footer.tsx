...
import { StravaActivitiesSkeleton, StravaAthleteStatsSkeleton } from './strava-skeleton';
...
function StravaFooter() {
  return (
    <div className="mx-auto w-full max-w-7xl space-y-6 md:px-4">
      <h1 className="text-center text-3xl font-bold italic">Training to First Marathon</h1>
