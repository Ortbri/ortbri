...
import type { AthleteStats } from '@/types/strava';
      ...
      <div className="w-full">
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          ...
          <div className="bg-card text-card-foreground rounded-3xl border p-6">
            <h3 className="mb-4 text-lg font-semibold">Recent (4 weeks)</h3>
            <div className="space-y-4">
              <StatItem label="Runs" value={profileStats.recent_run_totals.count.toString()} />
              <StatItem
                label="Distance"
          ...
          {/* YTD Run Stats */}
          <div className="bg-card text-card-foreground rounded-3xl border p-6">
            <h3 className="mb-4 text-lg font-semibold">Year to Date</h3>
            <div className="space-y-4">
              <StatItem label="Runs" value={profileStats.ytd_run_totals.count.toString()} />
              <StatItem
                label="Distance"
